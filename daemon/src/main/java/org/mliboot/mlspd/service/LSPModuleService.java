...
import org.mliboot.libxp.service.IXpService;

public class LSPModuleService extends IXpService.Stub {
    ...
    public int getFrameworkPrivilege() throws RemoteException {
        ensureModule();
        return IXpService.FRAMEWORK_PRIVILEGE_ROOT;
    }
